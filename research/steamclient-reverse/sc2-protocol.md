...
**Note**: Report ID (0x45) is NOT included in the notification data — BlueZ hog-ll
adds it from the Report Reference descriptor. The ATT notification payload is exactly
