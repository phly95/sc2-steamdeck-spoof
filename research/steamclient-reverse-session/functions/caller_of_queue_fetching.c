...
- Function start: `0x010b2ca0` (within `Steam_GSGetSteamID + 0xc1560`)
- Calls QueueFetchingControllerDetails at `0x010b2e53`

## Pseudocode

```c
// rdi = CSteamController* controller (saved to rbx)
